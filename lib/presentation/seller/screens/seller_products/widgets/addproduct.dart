  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        //centerTitle: true,
        title: Text("Add Product", style: greetingTextStyle.copyWith(fontSize: 20, color: Colors.white),),
      ),
            ...
            children: <Widget>[
              ...
              Row(
                ...
                children: [
                  ElevatedButton.icon(
                      ...
                      label: Text(' Capture Image ', style: facilityTextStyle.copyWith(color: Colors.white),)),
                  ElevatedButton.icon(
                      style: ElevatedButton.styleFrom(
                        backgroundColor: Colors.lightBlue,
                        maximumSize: Size.fromWidth(300),
                      ...
                      label: Text('Pick from Gallery', style: facilityTextStyle.copyWith(color: Colors.white),)),
                ],
              ),
              SizedBox(height: 30,),
              Container(
              ...
              Container(
                ...
                child: DropdownButtonFormField<String>(
                  ...
                  items: [
                    DropdownMenuItem(
                      child: Text('Select Category', style: facilityTextStyle,),
                      value: '',
                    ),
                    DropdownMenuItem(
                    ...
                    DropdownMenuItem(
                      child: Text('Food & Beverages', style: facilityTextStyle,),
                      value: 'food',
                    ),
                    DropdownMenuItem(
              ...
              Container(
                ...
                child: TextFormField(
                  controller: kdesc,
                  decoration: InputDecoration(labelText: 'Product Desciption', border: InputBorder.none, labelStyle: facilityTextStyle,),
                  maxLines: 3,
                  validator: (value) {
                    if (value!.isEmpty) {
              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(labelText: 'Price', border: InputBorder.none, labelStyle: facilityTextStyle,),
                  validator: (value) {
                    if (value!.isEmpty) {
              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  keyboardType: TextInputType.number,
                  decoration:
                      InputDecoration(labelText: 'Maximum Quantity to Order', border: InputBorder.none, labelStyle: facilityTextStyle,),
                  validator: (value) {
                    if (value!.isEmpty) {
              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  keyboardType: TextInputType.number,
                  decoration:
                      InputDecoration(labelText: 'Minimum Quantity to Order', border: InputBorder.none, labelStyle: facilityTextStyle,),
                  validator: (value) {
                    if (value!.isEmpty) {
